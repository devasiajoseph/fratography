...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_album', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category', null=True, to=orm['app.AlbumCategory']),
                      keep_default=False)

        # Adding field 'Album.subcategory'
        db.add_column('app_album', 'subcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subcategory', null=True, to=orm['app.AlbumCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.category'
        db.delete_column('app_album', 'category_id')

        # Deleting field 'Album.subcategory'
        db.delete_column('app_album', 'subcategory_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_contact', 'contact_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2013, 1, 21, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.contact_date'
        db.delete_column('app_contact', 'contact_date')
    ...
    models = {
        ...
        'app.contact': {
            ...
            'contact_date': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),

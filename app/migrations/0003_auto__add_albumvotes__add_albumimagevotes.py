...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlbumVotes'
        db.create_table('app_albumvotes', (
        ...
        db.send_create_signal('app', ['AlbumVotes'])

        # Adding model 'AlbumImageVotes'
        db.create_table('app_albumimagevotes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('album_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.AlbumImage'])),
        ))
        db.send_create_signal('app', ['AlbumImageVotes'])


    def backwards(self, orm):
        # Deleting model 'AlbumVotes'
        db.delete_table('app_albumvotes')

        # Deleting model 'AlbumImageVotes'
        db.delete_table('app_albumimagevotes')
    ...
    models = {
        ...
        'app.albumimagevotes': {
            'Meta': {'object_name': 'AlbumImageVotes'},

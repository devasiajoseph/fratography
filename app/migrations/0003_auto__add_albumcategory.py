...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_albumcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.AlbumCategory'])),
        ))
        db.send_create_signal('app', ['AlbumCategory'])


    def backwards(self, orm):
        # Deleting model 'AlbumCategory'
        db.delete_table('app_albumcategory')
    ...
    models = {
        ...
        'app.albumcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.AlbumCategory']"})
        },
        'app.albumimage': {

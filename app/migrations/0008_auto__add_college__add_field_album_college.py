...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_college', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal('app', ['College'])

        # Adding field 'Album.college'
        db.add_column('app_album', 'college',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.College'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'College'
        db.delete_table('app_college')

        # Deleting field 'Album.college'
        db.delete_column('app_album', 'college_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlbumCategory.parent'
        db.alter_column('app_albumcategory', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.AlbumCategory'], null=True))

    def backwards(self, orm):

        # Changing field 'AlbumCategory.parent'
        db.alter_column('app_albumcategory', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.AlbumCategory']))
